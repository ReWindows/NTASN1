...
static constexpr wchar_t module_name[11] = {0x004E, 0x0054, 0x0041, 0x0053, 0x004E, 0x0031, 0x002E, 0x0064, 0x006C, 0x006C, 0x0000};
...
if (live_timestamp != 2667946327U || rva >= image_size) return nullptr;
return base + rva;
}
