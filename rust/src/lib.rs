//! Windissect-generated Rust FFI bindings for NTASN1.dll. Windows only.
#![allow(non_snake_case, non_camel_case_types, dead_code)]

pub mod handles;
pub mod vtables;

pub const EXPECTED_PDB_GUID: &str = "5858845AC890E5F0CB04F2303DD78B3E";
pub const EXPECTED_PDB_AGE: u32 = 1;
pub const EXPECTED_PE_TIMESTAMP: u32 = 2667946327;
...
mod resolver {
    ...
    pub fn base() -> usize {
        ...
        let name: [u16; 11] = [78, 84, 65, 83, 78, 49, 46, 100, 108, 108, 0];
        ...
        if live_timestamp != 2667946327 { return 0; }
